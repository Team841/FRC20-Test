...
import org.usfirst.frc841.Eva.C;
import org.usfirst.frc841.Eva.Robot;
...
public class DriveTrain extends Subsystem {
    private double x,y,v,area;

    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTANTS

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTANTS
    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DECLARATIONS
    private final WPI_TalonSRX left1 = new WPI_TalonSRX(4);
    private final WPI_VictorSPX left2 = new WPI_VictorSPX(5);
    private final WPI_VictorSPX left3 = new WPI_VictorSPX(6);
    private final WPI_TalonSRX right1 = new WPI_TalonSRX(1);
    private final WPI_VictorSPX right2 = new WPI_VictorSPX(2);
    private final WPI_VictorSPX right3 = new WPI_VictorSPX(3);

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DECLARATIONS

    private final PWMVictorSPX leftSim = new PWMVictorSPX(4);
    private final PWMVictorSPX rightSim = new PWMVictorSPX(1);
    ...
    left1.configPeakCurrentLimit(20,0); //Current limit configuration - is this right?
